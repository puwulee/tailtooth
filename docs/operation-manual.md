...
4. [後台操作](#4-後台操作賽務管理)
   ...
   - 4.5 [申訴審理](#45-申訴審理)
   - 4.6 [公開排行榜](#46-公開排行榜)
   - 4.7 [選手公開檔案](#47-選手公開檔案)
   - 4.8 [報名管理](#48-報名管理)
   - 4.9 [裝備驗規](#49-裝備驗規beyblade-check)
   - 4.10 [贊助商管理](#410-贊助商管理)
...
賽季積分榜與「最強陀螺組合榜」，公開頁面（`/rankings`）供導購與話題行銷。

![排行榜](images/G1-rankings.png)

---

## 4.7 選手公開檔案

選手戰績、勝率、Finish 分布與成就徽章（冠軍/四強/老兵/極限大師/爆裂王），公開頁（`/players/{id}`）。

![選手檔案](images/G2-player-profile.png)

---

## 4.8 報名管理

主辦在後台檢視報名名單、手動報到、退費（開立折讓）。

![報名管理](images/G3-registrations.png)

---

## 4.9 裝備驗規（Beyblade Check）

裁判逐顆檢查選手陀螺是否合規，不通過需更換才可出戰；結果存證。

![裝備驗規](images/G4-equipment-check.png)

---

## 4.10 贊助商管理

新增贊助商與 Logo，露出於首頁、觀眾看板與直播 TV 版面。

![贊助商管理](images/G5-sponsors.png)
