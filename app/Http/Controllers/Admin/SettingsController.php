...
class SettingsController extends Controller
{
    ...
    public const FIELDS = [
        ...
        'line.login_channel_id' => ['line', false, 'LINE Login Channel ID'],
        'line.login_channel_secret' => ['line', true, 'LINE Login Channel Secret'],
        'line.login_callback' => ['line', false, 'LINE Login 回呼網址'],
